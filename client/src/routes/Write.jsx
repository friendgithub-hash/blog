...
const Write = () => {
  ...
  // useAuth is a hook; invoke it to access helpers
  ...
  const mutation = useMutation({
    ...
    onError: (error) => {
      ...
      alert("Could not create post: " + message);
    },
    onSuccess: (data) => {
  ...
  return (
    <div className="h-[calc(100vh-64px)] md:h-[calc(100vh-80px)] flex flex-col gap-6">
      <h1 className="text-xl font-light mb-4">Create a new post</h1>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6 flex-1 mb-6">
        ...
        <button
          ...
          type="submit"
        >
          {mutation.isLoading ? "Loading..." : "Publish"}
        </button>
